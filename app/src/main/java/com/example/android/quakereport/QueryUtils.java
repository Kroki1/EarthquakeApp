...
public final class QueryUtils {
    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        try {
            ...
            int howManyItems = featuresArray.length();
            Log.e (TAG, "MATS// Array has :" + howManyItems + " items");

            for (int i=0; i<featuresArray.length(); i++){

                JSONObject currentEq = featuresArray.getJSONObject(i);
                JSONObject propertiesObj = currentEq.getJSONObject("properties");
                ...
                Log.e (TAG, "MATS// Earthquake i: " + magnitude + ", " + location + ", " + time);
